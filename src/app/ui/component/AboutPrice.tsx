...
export default function AboutPriceSection() {
  return (
    <section className="py-24 bg-[#2D2A26] text-white relative overflow-hidden">
      
      {/* Фоновий шум (текстура дорогого паперу) - опціонально */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* ЛІВА ЧАСТИНА: Текст і переконання */}
          <motion.div 
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-[1.1]">
              ...
              <span className="text-[#D4AF37] italic">forever.</span>
            </h2>
            
            <p className="text-gray-300 text-lg leading-relaxed font-sans">
              Flowers die in a week. Dinner lasts an hour. But a song creates a memory that lives on repeat. 
              Usually, a custom studio track costs $300+, but we've optimized the process to make professional music accessible to everyone.
            </p>

            {/* Список переваг */}
            <div className="space-y-4 pt-4">
               {[
                 { icon: Mic2, text: "Professional Vocals & Mixing" },
                 { icon: Zap, text: "Fast 3-5 Day Delivery" },
                 { icon: CheckCircle2, text: "You Own the Song (Personal Use)" }
               ].map((item, i) => (
          ...
          >
             <div className="relative bg-[#D4AF37] text-[#2D2A26] p-8 md:p-12 rounded-[2rem] shadow-[0_0_60px_rgba(212,175,55,0.2)] w-full max-w-md text-center transform hover:-translate-y-2 transition-transform duration-500">
                ...
                <div className="mb-6">
                    <p className="text-sm font-bold uppercase tracking-widest opacity-70 mb-2">Flat Rate</p>
                    <div className="flex items-start justify-center gap-1 font-serif text-[#2D2A26]">
                        <span className="text-4xl font-bold mt-2">$</span>
                        <span className="text-8xl font-bold leading-none">59</span>
                    </div>
                    <p className="text-sm font-medium opacity-80 mt-2">No hidden fees. One-time payment.</p>
                </div>

                <div className="space-y-3 mb-8 text-left bg-black/5 p-6 rounded-xl">
                    <div className="flex justify-between items-center border-b border-black/10 pb-2">
                        <span className="font-medium">Lyrics writing</span>
                    ...
                    <div className="flex justify-between items-center">
                        <span className="font-medium">Artist fee</span>
                        <span className="font-bold">Included</span>
                    </div>
                </div>
